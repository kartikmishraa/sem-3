/*
    ---------------------------------------------------------------------------
    The program takes rows, columns and density of the sparse matrix as user 
    input, and creates a suitable sparse matrix. Further the program represents 
    randomly generated sparse matrix in triplet form using linked list
    ---------------------------------------------------------------------------
*/
